...
If you change Movie.Title to Movie.title:

You'll no longer be able to access it to initialize Movie.
title will be accessible only through its own package: the first package.
